package cn.my.music.mobile.widget;
...
public class MusicWidgetProvider extends AppWidgetProvider {
    ...
    public static final String ACTION_PLAY_PAUSE = "cn.my.music.mobile.widget.PLAY_PAUSE";
    public static final String ACTION_PREV = "cn.my.music.mobile.widget.PREV";
    public static final String ACTION_NEXT = "cn.my.music.mobile.widget.NEXT";
    public static final String ACTION_UPDATE_WIDGET = "cn.my.music.mobile.widget.UPDATE";

    // Internal actions to forward to JS to avoid loop
    public static final String INTERNAL_ACTION_PLAY_PAUSE = "cn.my.music.mobile.widget.INTERNAL_PLAY_PAUSE";
    public static final String INTERNAL_ACTION_PREV = "cn.my.music.mobile.widget.INTERNAL_PREV";
    public static final String INTERNAL_ACTION_NEXT = "cn.my.music.mobile.widget.INTERNAL_NEXT";
    ...
    private void updateWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        // Read saved state
        SharedPreferences prefs = context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE);
        String title = prefs.getString(KEY_TITLE, "魔音");
